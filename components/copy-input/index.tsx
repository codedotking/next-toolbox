...
export default function CopyInput({
  ...
  return (
    <div className="flex w-full gap-1.5 flex-col md:flex-row md:items-center">
      ...
      <div className="flex items-center  hover:outline-none hover:ring-1 hover:ring-ring  h-9 w-full rounded-md border border-input bg-transparent py-1 px-2 text-sm shadow-sm transition-colors  placeholder:text-muted-foreground">
        <Input value={value} className="border-none focus-visible:ring-0" />
        <div ref={copyIconRef}>
          <CopyIcon
